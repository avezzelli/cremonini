...
add_shortcode('printGestioneAziende', 'addPageManageAziende');
function addPageManageAziende(){
    include 'pages/azienda/manage.php';
}

add_shortcode('printBachecaGV', 'addPageBachecaGV');
function addPageBachecaGV(){
    include 'pages/bacheca/bacheca-collaudo-gv.php';
}
...
function aggiorna_voce_ajax(){
    zecchini\aggiornaVoce();
}
add_action('wp_ajax_aggiorna_voce', 'aggiorna_voce_ajax');
add_action('wp_ajax_nopriv_aggiorna_voce', 'aggiorna_voce_ajax');

function aggiorna_visibilita_ajax(){
    zecchini\aggiornaVisibilita();
}
add_action('wp_ajax_aggiorna_visibilita', 'aggiorna_visibilita_ajax');
add_action('wp_ajax_nopriv_aggiorna_visibilita', 'aggiorna_visibilita_ajax');
